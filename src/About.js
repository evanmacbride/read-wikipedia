...
const About = () => (
	<main>
		<article className="pageText">
			...
			<p>
				Read Wikipedia is a project by Evan MacBride. It was built with	<a href="https://reactjs.org/">React</a> and the <a href="https://www.mediawiki.org/wiki/API:Main_page">Wikipedia API</a>. It is not affiliated with Wikipedia or the Wikimedia Foundation in any way.
      </p>
      <p> 
